...
import dgd.models.equivariant.equivariant_utils as utils
from dgd.diffusion import diffusion_utils
from .equivariant_layers import Xtoy, Etoy, SE3Norm, PositionsMLP, masked_softmax, EtoX, SetNorm, GraphNorm
...
class XEyTransformerLayer(nn.Module):
    ...
    def forward(self, features: utils.EquiPlaceHolder):
        ...
        out = utils.EquiPlaceHolder(X=X, E=E, y=y, pos=new_pos, charges=None, node_mask=node_mask).mask()
...
class GraphTransformer(nn.Module):
    ...
    """
    def __init__(self, input_dims: utils.EquiPlaceHolder, n_layers: int, hidden_mlp_dims: dict, hidden_dims: dict,
                 output_dims: utils.EquiPlaceHolder):
        super().__init__()
    ...
    def forward(self, data: utils.EquiPlaceHolder):
        ...
        features = utils.EquiPlaceHolder(X=self.mlp_in_X(X), E=new_E, y=self.mlp_in_y(data.y), charges=None,
        ...
        out = utils.EquiPlaceHolder(pos=pos, X=final_X, charges=charges, E=E, y=y, node_mask=node_mask).mask()
        return out