...
class QM9DataModule(MolecularDataModule):
    ...
    def prepare_data(self) -> None:
        ...
        datasets = {
            "train": QM9Dataset(
                stage="train", root=root_path, remove_h=self.cfg.dataset.remove_h
            ),
            "val": QM9Dataset(
                stage="val", root=root_path, remove_h=self.cfg.dataset.remove_h
            ),
            "test": QM9Dataset(
                stage="test", root=root_path, remove_h=self.cfg.dataset.remove_h
            ),
        }
